...
t1e_normal_plt <- t1e_scenario_res_df %>%
  ...
  ggplot(aes(x = pgs_type, y = prop_sig, fill = pgs_type)) +
...
e_distributions_clean <- c("Std. normal", "Gamma", "Normal (\u03BC=10)")
...
```{r summary-figure, fig.asp=0.9, fig.width=10}
...
# bottom_panel <- (alt_pgs_effect_plt | (free(liver_diagram) + plot_annotation(tag = "e"))) +
